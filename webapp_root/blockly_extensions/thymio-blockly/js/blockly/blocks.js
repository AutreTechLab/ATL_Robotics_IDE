...
Blockly.Blocks['thymio_event_button'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("on")
        .appendField(new Blockly.FieldDropdown([["THYMIO_EVENT_BUTTON_CENTER","button.center"], ["THYMIO_EVENT_BUTTON_FORWARD","button.forward"], ["THYMIO_EVENT_BUTTON_BACKWARD","button.backward"], ["THYMIO_EVENT_BUTTON_LEFT","button.left"], ["THYMIO_EVENT_BUTTON_RIGHT","button.right"]]), "BUTTON")
        .appendField("button")
        .appendField(new Blockly.FieldDropdown([["option","THYMIO_EVENT_BUTTON_PRESS"], ["option","THYMIO_EVENT_BUTTON_RELEASE"]]), "MODE");
    this.appendStatementInput("HANDLER")
        .setCheck(null);
    this.setColour(20);
 this.setTooltip("THYMIO_EVENT_BUTTON_TOOLTIP");
 this.setHelpUrl("");
  }
};
...
Blockly.Blocks['thymio_event_prox'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("THYMIO_EVENT_PROX")
        .appendField(new Blockly.FieldDropdown([["THYMIO_EVENT_PROX_FRONT_LEFT","prox.horizontal[0]"], ["THYMIO_EVENT_PROX_FRONT_LEFT_MIDDLE","prox.horizontal[1]"], ["THYMIO_EVENT_PROX_FRONT_MIDDLE","prox.horizontal[2]"], ["THYMIO_EVENT_PROX_FRONT_RIGHT_MIDDLE","prox.horizontal[3]"], ["THYMIO_EVENT_PROX_FRONT_RIGHT","prox.horizontal[4]"], ["THYMIO_EVENT_PROX_REAR_LEFT","prox.horizontal[5]"], ["THYMIO_EVENT_PROX_REAR_RIGHT","prox.horizontal[6]"]]), "SENSOR")
        .appendField("")
        .appendField(new Blockly.FieldDropdown([["THYMIO_EVENT_PROX_PROX","PROX"], ["THYMIO_EVENT_PROX_NOPROX","NOPROX"]]), "MODE");
    this.appendStatementInput("HANDLER")
        .setCheck(null);
    this.setColour(20);
 this.setTooltip("");
...
Blockly.Blocks['thymio_event_prox_ground'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("on")
        .appendField(new Blockly.FieldDropdown([["THYMIO_EVENT_PROX_GROUND_LEFT","prox.ground.delta[0]"], ["THYMIO_EVENT_PROX_GROUND_RIGHT","prox.ground.delta[1]"]]), "SENSOR")
        .appendField("ground sensor detecting")
        .appendField(new Blockly.FieldDropdown([["THYMIO_EVENT_PROX_GROUND_BLACK","BLACK"], ["THYMIO_EVENT_PROX_GROUND_WHITE","WHITE"], ["THYMIO_EVENT_PROX_GROUND_PROX","PROX"], ["THYMIO_EVENT_PROX_GROUND_NOPROX","NOPROX"]]), "MODE");
    this.appendStatementInput("HANDLER")
        .setCheck(null);
    this.setColour(20);
 this.setTooltip("");
...
Blockly.Blocks.thymio_led_off={
    init:function(){this.jsonInit({
        message0:Blockly.Msg.THYMIO_LED_OFF,args0:[{
            type:"field_dropdown",name:"LED",
            options:[
...
Blockly.Blocks.thymio_sound_system=
    {init:function(){this.jsonInit({message0:Blockly.Msg.THYMIO_SOUND_SYSTEM,args0:[
        {type:"field_dropdown",name:"SOUND",options:[[Blockly.Msg.THYMIO_SOUND_SYSTEM_STARTUP,"0"],
        [Blockly.Msg.THYMIO_SOUND_SYSTEM_SHUTDOWN,"1"],[Blockly.Msg.THYMIO_SOUND_SYSTEM_ARROW,"2"],
        [Blockly.Msg.THYMIO_SOUND_SYSTEM_CENTRAL,"3"],[Blockly.Msg.THYMIO_SOUND_SYSTEM_SCARY,"4"],
        [Blockly.Msg.THYMIO_SOUND_SYSTEM_COLLISION,"5"],[Blockly.Msg.THYMIO_SOUND_SYSTEM_TARGET_FRIENDLY,"6"],
        [Blockly.Msg.THYMIO_SOUND_SYSTEM_TARGET_DETECTED,
"7"]]}]});
