...
static const _IDEWEBAPP_type_support_symbol_names_t _IDEWEBAPP_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, atl_ide_interfaces, msg, IDEWEBAPP)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, atl_ide_interfaces, msg, IDEWEBAPP)),
  }
};
...
{
  return &::atl_ide_interfaces::msg::rosidl_typesupport_cpp::IDEWEBAPP_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, atl_ide_interfaces, msg, IDEWEBAPP)() {
  return get_message_type_support_handle<atl_ide_interfaces::msg::IDEWEBAPP>();
}
